...
Note that this table was ordered by the size of $M_A(1)$, but 
$N_A(1)$ also decreases in step.
\begin{conjecture}
    Let $A,B$ be admissible k-tuples with $\#A=\#B$.
    Then $$M_A(1) \le M_B(1) \iff N_A(1) \le N_B(1).$$
\end{conjecture}
(TODO: I do not believe this is true, it just appears so for
everything I've tested. We should write a k-tuple generating 
routine and test over a large dataset.)

We see also that the final two entries for $N_A(1)$ appear to be exactly
equal. It is not a rounding error: they are indeed identical.
...
to have identical limiting frequency.
